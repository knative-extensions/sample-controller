...
const (
	controllerAgentName = "anotherthing.addressableservice-controller"
	finalizerName       = "anotherthing.addressableservice"
)

func NewImpl(ctx context.Context, r *Reconciler) *controller.Impl {
	logger := logging.FromContext(ctx)

	impl := controller.NewImpl(r, logger, "anotherthing.AddressableServices")
