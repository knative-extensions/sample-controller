...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SimpleDeployment, desiredFinalizers sets.Set[string]) (*v1alpha1.SimpleDeployment, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.SimpleDeployment, desiredFinalizers sets.Set[string]) (*v1alpha1.SimpleDeployment, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.SimpleDeployment, desiredFinalizers sets.Set[string]) (*v1alpha1.SimpleDeployment, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.SimpleDeployment, reconcileEvent reconciler.Event) (*v1alpha1.SimpleDeployment, error) {
	...
	if err != nil {
		...
		getter := r.Client.SamplesV1alpha1().SimpleDeployments(resource.Namespace)
