...
//var _ addressableservice.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ addressableservice.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.AddressableService) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.AddressableService) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
