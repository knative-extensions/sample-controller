...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AddressableService, desiredFinalizers sets.Set[string]) (*v1alpha1.AddressableService, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.AddressableService, desiredFinalizers sets.Set[string]) (*v1alpha1.AddressableService, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.AddressableService, desiredFinalizers sets.Set[string]) (*v1alpha1.AddressableService, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.AddressableService, reconcileEvent reconciler.Event) (*v1alpha1.AddressableService, error) {
	...
	if err != nil {
		...
		getter := r.Client.SamplesV1alpha1().AddressableServices(resource.Namespace)
