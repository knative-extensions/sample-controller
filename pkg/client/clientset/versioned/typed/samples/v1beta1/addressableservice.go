...
type AddressableServiceInterface interface {
	Create(*v1beta1.AddressableService) (*v1beta1.AddressableService, error)
	Update(*v1beta1.AddressableService) (*v1beta1.AddressableService, error)
	UpdateStatus(*v1beta1.AddressableService) (*v1beta1.AddressableService, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.AddressableService, error)
	List(opts v1.ListOptions) (*v1beta1.AddressableServiceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.AddressableService, err error)
...
func newAddressableServices(c *SamplesV1beta1Client, namespace string) *addressableServices {
...
func (c *addressableServices) Get(name string, options v1.GetOptions) (result *v1beta1.AddressableService, err error) {
	result = &v1beta1.AddressableService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *addressableServices) List(opts v1.ListOptions) (result *v1beta1.AddressableServiceList, err error) {
	result = &v1beta1.AddressableServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("addressableservices").
...
func (c *addressableServices) Create(addressableService *v1beta1.AddressableService) (result *v1beta1.AddressableService, err error) {
	result = &v1beta1.AddressableService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("addressableservices").
...
func (c *addressableServices) Update(addressableService *v1beta1.AddressableService) (result *v1beta1.AddressableService, err error) {
	result = &v1beta1.AddressableService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addressableservices").
...
func (c *addressableServices) UpdateStatus(addressableService *v1beta1.AddressableService) (result *v1beta1.AddressableService, err error) {
	result = &v1beta1.AddressableService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addressableservices").
...
func (c *addressableServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.AddressableService, err error) {
	result = &v1beta1.AddressableService{}
