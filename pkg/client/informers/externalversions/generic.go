...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("addressableservices"):
		...
		// Group=samples.knative.dev, Version=v1beta1
	case v1beta1.SchemeGroupVersion.WithResource("addressableservices"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Samples().V1beta1().AddressableServices().Informer()}, nil
