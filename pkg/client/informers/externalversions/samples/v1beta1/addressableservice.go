...
import (
	...
	v1beta1 "knative.dev/sample-controller/pkg/client/listers/samples/v1beta1"
)
...
type AddressableServiceInformer interface {
	...
	Lister() v1beta1.AddressableServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplesV1beta1().AddressableServices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplesV1beta1().AddressableServices(namespace).Watch(options)
			},
		},
		&samplesv1beta1.AddressableService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *addressableServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplesv1beta1.AddressableService{}, f.defaultInformer)
}

func (f *addressableServiceInformer) Lister() v1beta1.AddressableServiceLister {
	return v1beta1.NewAddressableServiceLister(f.Informer().GetIndexer())
}
